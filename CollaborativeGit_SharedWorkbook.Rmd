...
When youre adding new work, especially when many people might be doing things simultaneously, you might accidentally break someone elses code if you work directly on the default.

Even if you are working on your own (non-collaboratively) it is worth getting used to working on branches
...
**it is best practice to have this file on your local machine, but outside of the git folders so that it is not uploaded to GitHub or shared publically**
